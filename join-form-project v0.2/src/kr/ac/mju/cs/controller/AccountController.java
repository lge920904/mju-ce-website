...
public class AccountController {
	...
	public void createUser(User user) {
		...
		try {
			...
			System.out.println(user.getId() + user.getPassword()
					+ user.getName() + user.getEmail() + user.getCategory());
	...
	public void createProfessor(Professor professor) {
		...
		try {
			...
			pstmt.executeUpdate();
			System.out.println(professor.getId() + professor.getPassword()
					+ professor.getName() + professor.getEmail()
					+ professor.getCategory());
	...
	public void createStaff(Staff staff) {
		...
		try {
			...
			System.out.println(staff.getId() + staff.getPassword()
					+ staff.getName() + staff.getEmail() + staff.getCategory());
	...
	public Professor setSessionProfessor(User user) {
		...
		try {
			pstmt = conn
					.prepareStatement("select * from professor where email=?");
