...
public class EmailSender {
    ...
    private final String adminEmail = "noreply-ce@administrator.com";
    private final String username = "lge920904@gmail.com";
    private final String password = "2rkdmftkfkdgo";
