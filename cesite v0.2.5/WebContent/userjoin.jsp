...
<article class="article">
	<form method="POST" action="UserJoinServlet?action=join" name="joinform" id="joinform" enctype="multipart/form-data">
		<div class="section">
			...
			<p>
				<input type="button" name="submitButton" onclick="validate()" value="회원가입">
...
/* submit */
 function validate(){
	if(!document.getElementsByName("btn-id")[0].getAttribute("disabled") ||
		!document.getElementsByName("user-password-confirm")[0].getAttribute("readonly") ||
