	...
	protected void doPost(HttpServletRequest request,
		...
		if (action.equals("isMember")) {
			...
			if (category.equals("member")) {
				...
				System.out.println("member:"+id+"/"+password+"/"+name+"/"+email+"/"+category);
				...
				String option = multipartRequst.getParameter("user-non-member-select");
				NonMember nonMember = new NonMember(id, password, name, email, photo, 4, option);
				System.out.println("member:"+id+"/"+password+"/"+name+"/"+email+"/"+category+"/"+option);
